...
I. Acquisition
API Infrastructure
Develop the Python script using fredapi to programmatically pull RTWEXBGS and EXPGS
March 15
Member 1
II. Integration
Temporal Alignment
Resample weekly Dollar Index data into quarterly averages and perform an inner join with Export data
March 20
Member 1
III. Quality
Data Audit & Profiling
Conduct a formal Data Quality Assessment (Module 10) identifying outliers, nulls, and seasonal adjustment status
March 25
Member 2
IV. Reporting
Interim Status Report
Draft the 1000–1500 word status report (Milestone 3) detailing progress and any shifted constraints
March 31
Both
V. Wrangling
Data Cleaning
Apply transformations (percentage change) and handle any identified outliers or missing observations
April 07
Member 2
VI. Analysis
Correlation & Lag Study
Calculate Pearson r coefficients and visualize the two-quarter lag effect between the variables
April 15
Member 1
VII. Provenance
Automation & Metadata
Finalize the end-to-end automated workflow script and create the Data Dictionary/JSON metadata (Module 15)
April 25
Member 2
VIII. Delivery
Final Release
Conduct final code review, update README, and create the final-project tag and release on GitHub
May 03
Both
